...
//
//
// let cloneNewdDiv = newDiv.cloneNode(true);
//
//
// element.appendChild(cloneNewdDiv)
//
// console.log(element)
...
// newLi1.textContent = arr[0]
//
// let newLi2 = document.createElement('li')
// newLi2.textContent = arr[1]
//
// let newLi3 = document.createElement('li')
// newLi3.textContent = arr[2]
//
// let newLi4 = document.createElement('li')
// newLi4.textContent = arr[3]
...
//     block.textContent ='Title: ' + arrElement.title + ', mountDuration: ' + arrElement.monthDuration;
...
//     block.appendChild(p)
//     h1.textContent ='title: ' + arrElement.title ;
//     p.textContent ='monthDuration: ' + arrElement.monthDuration ;
//
//     element.appendChild(block)
// }
// console.log(element)
...
//     block.textContent = 'name: ' + simpson.name + '  surname: ' + simpson.surname + '  age: ' + simpson.age //+ 'info: ' + simpson.info + 'photo: ' + simpson.photo;
//
//
//
//     element.appendChild(block)
...
for (const arrElement of coursesArray) {
    let block = document.createElement('div')
        ...
        divTitle.textContent = 'title: ' + arrElement.title

        let divMonth = document.createElement('div')
        divMonth.textContent = 'month: ' + arrElement.monthDuration
        ...
        arrElement.modules.forEach(module => {
            ...
            divLi.textContent = module
            divUl.appendChild(divLi)
        })

        divModules.appendChild(divUl)

        block.appendChild(divTitle)
        block.appendChild(divMonth)
        block.appendChild(divHour)
        block.appendChild(divModules)
    element.appendChild(block)
}
console.log(element)
